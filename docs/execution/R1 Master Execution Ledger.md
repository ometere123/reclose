...
| 67-71 | E1/H1 | canonical live scenario x2, 78-scenario benchmark, hardening | IN PROGRESS - A2-C01 is live-verified closed; E1 waits for corrected immutable-snapshot Judge/Vault and new policy. No incident run submitted. | release-evidence/r1/e1/fixtures/ | scripts/check-e1-evidence.mjs | pending two genuine runs | ea7dfb7 | Old policy-r1-007 sealed/inactive and superseded before activation; do not claim E1/H1 completion. |
