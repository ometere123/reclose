...
const JUDGE = "0xcdC5ce7A17cBecbBDCde4F5FA65E83366B018819";
const KERNEL = "0xa0a967Db641af4E62DB36367F560afb21cc7Ec00";
const TARGET_CONTRACT = "0xC8B75C6a131d601f8C1A3d0a82ffEd4Be2D58AD2";
const DEPLOYER = "0x24fAe7cD031Ed702Be63BDeA8912141805B996bd";
const TARGET_ID = "reclose-target-005";
const POLICY_KEY = "policy-r1-006";
const POLICY_HASH = "0x1f6309b5adefdd8244cdd3fec1fde2623233f9b3ea869b25aadc7bd661205d9b";
const RULE_ID = "PROVIDER_COMPROMISE_V1";
const RESOURCE_ID = "provider_a";
const REPORTER_NONCE = 0; // fresh deployment, confirmed via get_reporter_nonce
