...
const mode = process.env.RECLOSE_MODE ?? "purchase-b", target = m.contracts.ReferenceAgentProtocol.address, provider = mode === "purchase-a" ? m.contracts.ProviderStubA.address : m.contracts.ProviderStubB.address;
